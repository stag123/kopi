...
var _village2 = _interopRequireDefault(__webpack_require__(18));
...
var _dom = _interopRequireDefault(__webpack_require__(20));

var _default = _interopRequireDefault(__webpack_require__(21));

__webpack_require__(39);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MIN_DISTANCE_FROM_VIEWPORT_BORDER = 10;
/** Local variables */
...
div.innerHTML = (0, _default.default)();

var _tooltipElement = div.querySelector(".tooltip");

console.log(div);

var _tooltipText = _tooltipElement.querySelector(".tooltip-inner"),
    _tooltipVisible = false,
    _tooltipArrow = _tooltipElement.querySelector(".arrow");
/** Initialization */


var elements = document.querySelectorAll(_tooltipSelector);
...
function _updateTooltip(e) {
  e.stopPropagation();
  var boundElement = e.currentTarget,
  ...
  elementBox = _dom.default.getBox(boundElement);
...
function _showTooltip(text, elementBox) {
  _timer = window.setTimeout(function () {
    ...
    var tooltipBox = _dom.default.getBox(_tooltipElement),
        ...
        tooltipStyle; // Tooltip out of viewport


    if (left < MIN_DISTANCE_FROM_VIEWPORT_BORDER) {
      left = MIN_DISTANCE_FROM_VIEWPORT_BORDER;

      _dom.default.css(_tooltipArrow, 'left', elementBox.center - left + 'px');
      ...
      _dom.default.css(_tooltipArrow, 'left', tooltipBox.innerWidth / 2 + 'px');
    }
    ...
    if (!above) {
      _dom.default.addClass(_tooltipElement, "below");
    } else {
      _dom.default.removeClass(_tooltipElement, "below");
    }

    _dom.default.css(_tooltipElement, tooltipStyle);
...
function _hideTooltip() {
  ...
  _dom.default.css(_tooltipElement, {
    opacity: 0,
    top: -12000,
    left: -12000
  });
...
/** DOM */
var UNDIMESIONED_PROPS = "zoom,opacity,z-index";
...
function () {
  ...
  _createClass(DOM, null, [{
     ...
     * @returns {Event}
     */
    value: function css(element, style, value) {
      if (!!element.get) element = element.get(0);
      if (!element) throw new TypeError("Element not specified");
      if (!style || typeof style !== 'string' && _typeof(style) !== 'object') throw new TypeError("Style must be a string or an object");

      if (typeof style === "string" && typeof value !== "string" && typeof value !== false) {
      ...
      var setStyle = function setStyle(element, style, value) {
        ...
        if (typeof value === "number" && UNDIMESIONED_PROPS.indexOf(style) === -1) {
          value = value + "px";
        }
    ...
    key: "treeMatches",
    value: function treeMatches(element, checkFunction) {
    ...
    key: "hasParent",
    value: function hasParent(element, parent) {
      var depth = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 5;
      return DOM.treeMatches(element, function (currentParent) {
    ...
    key: "recreateElement",
    value: function recreateElement(node) {
